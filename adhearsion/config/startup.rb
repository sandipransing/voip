...
Adhearsion::Configuration.configure do |config|
  ...
  config.asterisk.listening_port = 1050  
  # AMI
  config.asterisk.enable_ami :host => "dellserver", :username => "rubyconf", :password => "Asterisk2010", :events => true
  
  # Adhearsion DRB instance
  config.enable_drb :port => 9092
